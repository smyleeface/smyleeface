...
ZSH_THEME_VIRTUALENV_SUFFIX=" ${PR_LIGHT_BLUE}:: "
...
${PR_CYAN}%(!.%SROOT%s.%n)${PR_GREY}@${PR_CYAN}%m:%l\
${PR_GREY})${PR_CYAN}${PR_HBAR}${PR_URCORNER}\

${PR_CYAN}${PR_LLCORNER}${PR_BLUE}${PR_HBAR}(\
${PR_YELLOW}$(virtualenv_prompt_info)\
...
(${PR_YELLOW}%D{%H:%M:%S} %D{%a, %b%d}${PR_BLUE})${PR_HBAR}${PR_CYAN}${PR_LRCORNER}${PR_NO_COLOUR}'
